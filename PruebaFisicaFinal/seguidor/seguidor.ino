...
//      (sensorValues[7] > 900) {
//       avanzarMotoresSincronizados(motorIzq, motorDer, 1.7, 1.7, true, false);
//       motorsOFF(true);
//       Serial.println("Girar a la Izquierda");
//       avanzarMotoresSincronizados(motorIzq, motorDer, 1.3, 1.3, false, false); // Giro de 90° a la izquierda
//       motorsOFF(true);
//       delay(2000);
//     }
...
//       avanzarMotoresSincronizados(motorIzq, motorDer, 1.3, 1.3, true, true); // Giro de 90° a la derecha
//       motorsOFF(true);
//       delay(1000);
//     }
...
uint16_t position = qtr.readLineBlack(sensorValues);
  //if (sensorValues [0] > 900 && sensorValues[7] > 900) {
    ...
    //avanzar (vMedium, vMedium);
  //} else 
  if (sensorValues[5] > 900 || sensorValues[6] > 900 || sensorValues[7] > 900) {
  // Si los sensores [3][4] detectan linea negra siga recto
  ...
  // Si el sensor [2] detecta negro ir a la derecha
  else if (sensorValues[2] > 900 || sensorValues[1] > 900 || sensorValues[0] > 900) {
    // Si los sensores [0][1][2] detectan negro parar y hacer un giro de 90 a la derecha
